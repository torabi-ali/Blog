        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Post_AspNetUsers_DeleteUserId",
                        column: x => x.DeleteUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Post_AspNetUsers_InsertUserId",
                        column: x => x.InsertUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Post_AspNetUsers_UpdateUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Post_DeleteUserId",
                table: "Post",
                column: "DeleteUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Post_InsertUserId",
                table: "Post",
                column: "InsertUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Post_UpdateUserId",
                table: "Post",
                column: "UpdateUserId");
